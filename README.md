...
| `epsilon_decay` | 0.985 | Коэффициент убывания ε **за эпизод** |
...
|---|---|---|
| Шаг ближе к цели | 0.0 | -0.1 + 0.1·(old\_dist - new\_dist) = -0.1 + 0.1·1 |
...
...
✓ Цель достигнута за 10 шагов. Суммарная награда: 10.00
```
